...
class MyCustomTrainer:
    ...
    def fit(
        ...
        if isinstance(self.fabric.strategy, L.fabric.strategies.xla_fsdp.XLAFSDPStrategy):
    ...
    def val_loop(
        ...
        if self.fabric.is_global_zero and self._current_val_return is not None:
            self.fabric.log("val_loss", self._current_val_return)
    ...
    def training_step(self, model: L.LightningModule, batch: Any, batch_idx: int) -> torch.Tensor:
        ...
        self.fabric.log("train_loss", self._current_train_return)
        return loss
    ...
    def _format_iterable(
        prog_bar, candidates, prefix: str
    ):
